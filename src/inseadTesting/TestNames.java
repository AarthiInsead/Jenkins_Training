...
public class TestNames {
  ...
  public void FUNC321002_1_Update_an_active_Primary_Name_in_Peoplesoft(TestParameters testParameters, MyInseadUser user) throws InterruptedException
  {
			 ...
			 driver.get("https://www.insead.edu/");
			 
			 driver.findElement(By.partialLinkText("PROGRAMMES")).click();
			 driver.findElement(By.partialLinkText("Executive Education"));
			 WebDriverWait wait = new WebDriverWait(driver, 1);
			 
			 WebElement searchMainData = driver.findElement(By.partialLinkText("Corporate Governance"));
			 searchMainData.click();
			 
			 
			// WebElement subBtn = driver.findElement(By.name("btnK"));
			 
			// subBtn.submit();			 
			 
			 wait.until(ExpectedConditions.urlContains("corporate-governance"));
			 
			 Assert.assertEquals(driver.getCurrentUrl(), "https://www.insead.edu/executive-education/corporate-governance");
			 
			 WebElement result = driver.findElement(By.partialLinkText("Corporate Governance"));
			 

			 
			 Assert.assertNotNull(result,"Couldn't find the page");
			 
			 driver.findElement(By.className("dl-horizontal")).click();			 
